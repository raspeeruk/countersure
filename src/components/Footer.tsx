      ...
      <div className="max-w-[1280px] mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 font-body text-sm">
            ...
            <li><Link href="/check-eori" className="hover:text-customs-green">EORI check</Link></li>
            <li><Link href="/bulk" className="hover:text-customs-green">Bulk check</Link></li>
            <li><Link href="/api" className="hover:text-customs-green">API</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 font-body text-sm">
            <li><Link href="/guides" className="hover:text-customs-green">Guides</Link></li>
            <li><Link href="/vat-fraud-index" className="hover:text-customs-green">VAT Fraud Index</Link></li>
          </ul>
        </div>
        <div>
          <div className="font-mono text-xs uppercase tracking-widest text-stamp-red mb-3">
